...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        #检测
        # self.add_argument("-c", "--config", default="../configs/det/det_mv3_db_v1.1.yml", help="configuration file to use")
        # 评估
        # self.add_argument("-c", "--config", default="../configs/rec/rec_icdar15_train.yml", help="configuration file to use")
        # 识别
        self.add_argument("-c", "--config", default="../configs/rec/rec_icdar15_train.yml", help="configuration file to use")
        # self.add_argument("-c", "--config", default="../configs/rec/rec_icdar15_train.yml", help="configuration file to use")
        self.add_argument(
